...
module.exports = {
	// Project Identity
	appName: 'twentytwentyDarkmode', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'twentytwenty-darkmode', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'twentytwentyDarkmode',
		author: '',
		license: 'UNLICENSED',
		link: 'UNLICENSED',
		version: pkg.version,
		...
		// If this has length === 1, then single compiler
		{
			...
			entry: {
		     ...
		     // global namespace pollutions 😉
				main: './src/js/main.js', // Could be a string
				editor: ['./src/js/editor.js'], // Or an array of string (string[])
			},
